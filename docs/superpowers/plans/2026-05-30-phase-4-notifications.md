...
**Reference:** design spec `docs/specs/2026-05-30-phase-4-notifications.md` (Groups A–E, A35–A41); product spec `spec.md` §9 (Notifications) + §5.4 (NotificationSettings); exemplars `docs/superpowers/plans/2026-05-30-phase-3a-filtering-navigation.md`, `…-3b-organize.md`, `…-3c-insights-data.md`.
