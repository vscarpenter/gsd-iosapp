# Code Standards & Agentic Guidance v16.0

**Purpose.** Directives governing how LLMs approach complex, multi-step development tasks. Optimized for Claude Opus 4.8 and the Claude Code harness. Opus 4.8 is a drop-in over 4.7, so prior tuning still applies; the deltas are noted in Part 0. Every directive applies to every coding session.
...
| Identical logic in three or more places | Part 2: Structure & Abstraction |
...
>
> Vinny Carpenter, Document Version 16.0
